...
$iisAppName = "Wontok Services"
$iisHostName = "facade.wontok.net"
$directoryPath = "c:\inetpub\wwwroot\Wontok.Facade.WebApi2"
...
Get-WebSite -Name "Wontok Services" | Remove-WebSite -Confirm:$false -Verbose
